...
// --- Elements ---
const img3 = document.querySelector('.img3'); // shaft
const img5 = document.querySelector('.img5'); // weight
const img4 = document.querySelector('.img4'); // valve
const img6 = document.querySelector('.img6'); // fountain
const img7 = document.querySelector('.img7'); // rising water
const img8 = document.getElementById('img8');
const fountainSound = document.getElementById('fountainSound');
const stopwatch = document.getElementById('stopwatch');
const screen2Header = document.querySelector('#screen2 .header-bar h1');
...
// --- Arrow System ---
function pointArrowTo(element, offsetX = 0, offsetY = -60) {
  const rect = element.getBoundingClientRect();
  const parentRect = element.offsetParent.getBoundingClientRect();

  guideArrow.style.left =
    rect.left - parentRect.left + rect.width / 2 + offsetX + "px";

  guideArrow.style.top =
    rect.top - parentRect.top + offsetY + "px";
...
img5.addEventListener('click', () => {
  ...
  setTimeout(() => {
    screen2Header.textContent = otherHeaders[0];
    pointArrowTo(img4);
  }, 700);
});
...
img4.addEventListener('click', () => {
  ...
  if (!valveOpen) {
    ...
    screen2Header.textContent = otherHeaders[1];
    hideArrow();
    ...
    setTimeout(() => {
      ...
      stopwatchInterval = setInterval(() => {
        ...
        if (seconds >= 30) {
          clearInterval(stopwatchInterval);
          stopwatchCompleted = true;
          screen2Header.textContent = otherHeaders[2];
        }
      }, 1000);
    }, 1000);
    ...
    screen2Header.textContent = otherHeaders[3];
    valveOpen = false;
    stopwatchCompleted = false;
